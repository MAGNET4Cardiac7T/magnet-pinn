...
from magnet_pinn.losses.physics import DivergenceLoss, FaradayLawLoss
...
div_loss_fn = DivergenceLoss(reduction=None)
...
divergence_dict = {
    key: div_loss_fn(value, item['subject']) for key, value in field_dict.items()
}
