"""Utility functions for PyTorch DataLoader workers.

This module provides helper functions for configuring DataLoader workers
to properly partition datasets across multiple worker processes.
"""
